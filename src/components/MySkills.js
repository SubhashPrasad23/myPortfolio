  ...
  return (
    ...
    <div className="w-full flex items-center justify-center  py-6 ">
      <div className="text-white w-4/5 space-y-5 py-2">
        <h4
          className="text-white text-3xl font-semibold tracking-widest  text-center"
          
        >
          MY <span className="text-emerald-400">SKILLS</span>
        </h4>

        <div className="w-full h-full  flex flex-wrap items-center justify-center gap-4   py-2 ">
          {skills.map((data, idx) => (
            <motion.div
              key={idx}
              ...
              className={`lg:w-56 w-full flex lg:flex-col items-center justify-center   lg:px-7 lg:py-3 py-2 rounded-lg duration-500 ${
                index === idx
                  ? "text-red-900 shadow-lg shadow-gray-500"
                  : "text-gray-900"
            ...
            >
              <div className="flex flex-col items-center  lg:gap-3  ">
                <img src={data.img} className="h-14 w-14" alt={data.skill} />
